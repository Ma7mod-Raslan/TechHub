// ============================================================
// Contact.tsx — Student Contact Page (Clean Version)
// ============================================================
...
import { sendContactMessage } from "../student/config/studentApi";
import { getStudentMenuItems } from "../student/config/studentMenu";

interface Props { logout: () => void; userRole: "student"; }

export default function StudentContact({ logout, userRole }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      <div className="flex relative">
        <Sidebar menuItems={getStudentMenuItems("/student/contact")} logout={logout} userRole="student" activePage="student-contact" isMobileOpen={isMobileOpen} setIsMobileOpen={setIsMobileOpen} />

// ============================================================
// ForgotPassword.tsx — Clean Version
// ============================================================
...
import { forgotPassword } from "../auth/config/authApi";
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-cyan-50 to-blue-50 flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">{sent ? "We've sent a password reset code to your email" : "Enter your email and we'll send you a reset code"}</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="mt-6 text-center">
              <button onClick={() => navigate("/login")} className="inline-flex items-center gap-2 text-sm text-cyan-600 hover:text-cyan-700">
